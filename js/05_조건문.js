...
function check3(){
    ...
    if(randomNumber == 0){
        ...
        message += "양수입니다"; // 양수인 경우
    }

    else {
        message += "음수입니다"; // 0도, 양수도 아닌 경우 == 음수인 경우
    }
...
function calc(op){
    ...
    switch(op){
        ...
        /* op 값에 따른 처리 case 작성 */
        /* break(멈추다) : switch문을 멈춘다 -> case에 break;를 작성하지 않으면 멈추지 않고 다음 case로 넘어가진다 */
