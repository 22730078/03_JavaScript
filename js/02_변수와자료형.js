/* console.log(값) : 브라우저 콘솔에 괄호() 내부의 값을 기록(출력) */
console.log(1234);
...
/* number1,number 2의 합 출력하기 */
console.log(number1+number2);

/* 변수에 대입한 값 변경하기 */
number1 = 300; // number1에 300 대입(기존 값 10을 덮어 씀)
number2 = 400;
...
/* var, let, const의 차이점 */
// 1. var (변수, 변수 선언 시 중복되는 변수명으로 선언 가능 -> 먼저 선언된 변수가 나중에 선언된 변수에 덮어 씌워짐)
var menu = "삼겹살";
console.log("menu : ",menu);

var menu = "초밥";
console.log("menu : ", menu);
// 변수명이 중복되어 덮어쓰게되면 이전에 선언해놓은 변수를 쓸 수 없게 되는 문제가 생김
...
/*  object (객체) : (쉬운 버전 설명) 값을 여러 개 저장할 수 있는 형태 */
...
// 2) JS 객체(object) : 값을 K:V (Map 형식)으로 여러 개 저장하는 형태 -> { K:V , K:V , K:V }
...
console.log("user['puserNamew'] ", user['userName'], typeof user['userName']);
...
/* 
함수(function) 
: [작성법] const 변수명 = function(){}; 
: 변수명 == 함수명
*/
const sumFn = function(a,b){return a+b;}
console.log(typeof sumFn); //타입확인
console.log(sumFn(3,5)); // 함수호출(기능수행)